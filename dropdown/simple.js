...
selectBase.addEventListener("change", function() {
	activeOption = 'base';
	// let color = parts['pa_base'][this.value].color;
	let part = parts['pa_back'][this.value];
	let color = '0xffffff';
	if(part)color = part.color;
	selectSwatch(color);
...
selectCushions.addEventListener("change", function() {
	activeOption = 'cushions';
	// let color = parts['pa_cushions'][this.value].color;
	let part = parts['pa_back'][this.value];
	let color = '0xffffff';
	if(part)color = part.color;
	selectSwatch(color);
...
selectLegs.addEventListener("change", function() {
	activeOption = 'legs';
	// let color = parts['pa_legs'][this.value].color;
	let part = parts['pa_back'][this.value];
	let color = '0xffffff';
	if(part)color = part.color;
	selectSwatch(color);
...
selectSupports.addEventListener("change", function() {
	activeOption = 'supports';
	// let color = parts['pa_supports'][this.value].color;
	let part = parts['pa_back'][this.value];
	let color = '0xffffff';
	if(part)color = part.color;
	selectSwatch(color);
